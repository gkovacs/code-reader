...
(function(){
  var root, querystring, http_get, async, nstore, repositories_db, codesearch_db, rootURL, fs, client_id, client_secret, ref$, wrapGH, wrapGHJSON, getRepositoriesRawUncached, getRepositoriesRaw, errWrap, getRepositories, searchCodeRawUncached, searchCodeRaw, sortCompare, searchCode, main, slice$ = [].slice;
